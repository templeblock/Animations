...
HX_DEFINE_STACK_FRAME(_hx_pos_f4710df4097d8f8b_27_new,"Date","new",0x9aa26240,"Date.new","/Applications/blender.app/armsdk/Kha/Tools/haxe/std/cpp/_std/Date.hx",27,0x96e783b1)
HX_LOCAL_STACK_FRAME(_hx_pos_f4710df4097d8f8b_31_getTime,"Date","getTime",0x0cac7da3,"Date.getTime","/Applications/blender.app/armsdk/Kha/Tools/haxe/std/cpp/_std/Date.hx",31,0x96e783b1)
HX_LOCAL_STACK_FRAME(_hx_pos_f4710df4097d8f8b_48_toString,"Date","toString",0xd2a372cc,"Date.toString","/Applications/blender.app/armsdk/Kha/Tools/haxe/std/cpp/_std/Date.hx",48,0x96e783b1)
HX_LOCAL_STACK_FRAME(_hx_pos_f4710df4097d8f8b_51_now,"Date","now",0x9aa26af6,"Date.now","/Applications/blender.app/armsdk/Kha/Tools/haxe/std/cpp/_std/Date.hx",51,0x96e783b1)
HX_LOCAL_STACK_FRAME(_hx_pos_f4710df4097d8f8b_54_new1,"Date","new1",0xb37395f1,"Date.new1","/Applications/blender.app/armsdk/Kha/Tools/haxe/std/cpp/_std/Date.hx",54,0x96e783b1)
HX_LOCAL_STACK_FRAME(_hx_pos_f4710df4097d8f8b_57_fromTime,"Date","fromTime",0x44fd3cb7,"Date.fromTime","/Applications/blender.app/armsdk/Kha/Tools/haxe/std/cpp/_std/Date.hx",57,0x96e783b1)
HX_LOCAL_STACK_FRAME(_hx_pos_f4710df4097d8f8b_64_fromString,"Date","fromString",0x5ead97fb,"Date.fromString","/Applications/blender.app/armsdk/Kha/Tools/haxe/std/cpp/_std/Date.hx",64,0x96e783b1)

void Date_obj::__construct(int year,int month,int day,int hour,int min,int sec){
            	HX_STACKFRAME(&_hx_pos_f4710df4097d8f8b_27_new)
...
Float Date_obj::getTime(){
            	HX_STACKFRAME(&_hx_pos_f4710df4097d8f8b_31_getTime)
...
::String Date_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_f4710df4097d8f8b_48_toString)
...
HX_DEFINE_DYNAMIC_FUNC0(Date_obj,toString,return )
 ...
 ::Date Date_obj::now(){
            	HX_STACKFRAME(&_hx_pos_f4710df4097d8f8b_51_now)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(Date_obj,now,return )
 ...
 ::Date Date_obj::new1( ::Dynamic t){
            	HX_GC_STACKFRAME(&_hx_pos_f4710df4097d8f8b_54_new1)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Date_obj,new1,return )
 ...
 ::Date Date_obj::fromTime(Float t){
            	HX_GC_STACKFRAME(&_hx_pos_f4710df4097d8f8b_57_fromTime)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Date_obj,fromTime,return )
 ...
 ::Date Date_obj::fromString(::String s){
            	HX_GC_STACKFRAME(&_hx_pos_f4710df4097d8f8b_64_fromString)
