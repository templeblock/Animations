...
HX_DEFINE_STACK_FRAME(_hx_pos_e86bacb14cfce6cb_31_new,"haxe.Utf8","new",0x67cc940b,"haxe.Utf8.new","/Applications/blender.app/armsdk/Kha/Tools/haxe/std/cpp/_std/haxe/Utf8.hx",31,0x32f155c3)
HX_LOCAL_STACK_FRAME(_hx_pos_e86bacb14cfce6cb_38_addChar,"haxe.Utf8","addChar",0x9a1816c2,"haxe.Utf8.addChar","/Applications/blender.app/armsdk/Kha/Tools/haxe/std/cpp/_std/haxe/Utf8.hx",38,0x32f155c3)
HX_LOCAL_STACK_FRAME(_hx_pos_e86bacb14cfce6cb_42_toString,"haxe.Utf8","toString",0xb459e121,"haxe.Utf8.toString","/Applications/blender.app/armsdk/Kha/Tools/haxe/std/cpp/_std/haxe/Utf8.hx",42,0x32f155c3)
HX_LOCAL_STACK_FRAME(_hx_pos_e86bacb14cfce6cb_66_charCodeAt,"haxe.Utf8","charCodeAt",0xce7cbeab,"haxe.Utf8.charCodeAt","/Applications/blender.app/armsdk/Kha/Tools/haxe/std/cpp/_std/haxe/Utf8.hx",66,0x32f155c3)
HX_LOCAL_STACK_FRAME(_hx_pos_e86bacb14cfce6cb_74_length,"haxe.Utf8","length",0x88322e1b,"haxe.Utf8.length","/Applications/blender.app/armsdk/Kha/Tools/haxe/std/cpp/_std/haxe/Utf8.hx",74,0x32f155c3)
HX_LOCAL_STACK_FRAME(_hx_pos_e86bacb14cfce6cb_82_sub,"haxe.Utf8","sub",0x67d06d2b,"haxe.Utf8.sub","/Applications/blender.app/armsdk/Kha/Tools/haxe/std/cpp/_std/haxe/Utf8.hx",82,0x32f155c3)
namespace haxe{

void Utf8_obj::__construct( ::Dynamic size){
            	HX_STACKFRAME(&_hx_pos_e86bacb14cfce6cb_31_new)
...
void Utf8_obj::addChar(int c){
            	HX_STACKFRAME(&_hx_pos_e86bacb14cfce6cb_38_addChar)
...
::String Utf8_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_e86bacb14cfce6cb_42_toString)
...
int Utf8_obj::charCodeAt(::String s,int index){
            	HX_STACKFRAME(&_hx_pos_e86bacb14cfce6cb_66_charCodeAt)
...
int Utf8_obj::length(::String s){
            	HX_STACKFRAME(&_hx_pos_e86bacb14cfce6cb_74_length)
...
::String Utf8_obj::sub(::String s,int pos,int len){
            	HX_STACKFRAME(&_hx_pos_e86bacb14cfce6cb_82_sub)
