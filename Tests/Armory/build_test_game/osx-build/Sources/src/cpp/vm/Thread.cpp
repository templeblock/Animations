...
HX_DEFINE_STACK_FRAME(_hx_pos_b6868f9adf03d100_31_new,"cpp.vm.Thread","new",0x66262c28,"cpp.vm.Thread.new","/Applications/blender.app/armsdk/Kha/Tools/haxe/std/cpp/vm/Thread.hx",31,0x53f8ef28)
HX_LOCAL_STACK_FRAME(_hx_pos_b6868f9adf03d100_38_sendMessage,"cpp.vm.Thread","sendMessage",0x48dced27,"cpp.vm.Thread.sendMessage","/Applications/blender.app/armsdk/Kha/Tools/haxe/std/cpp/vm/Thread.hx",38,0x53f8ef28)
HX_LOCAL_STACK_FRAME(_hx_pos_b6868f9adf03d100_66___compare,"cpp.vm.Thread","__compare",0x3204cb4d,"cpp.vm.Thread.__compare","/Applications/blender.app/armsdk/Kha/Tools/haxe/std/cpp/vm/Thread.hx",66,0x53f8ef28)
HX_LOCAL_STACK_FRAME(_hx_pos_b6868f9adf03d100_46_current,"cpp.vm.Thread","current",0x21a37c01,"cpp.vm.Thread.current","/Applications/blender.app/armsdk/Kha/Tools/haxe/std/cpp/vm/Thread.hx",46,0x53f8ef28)
HX_LOCAL_STACK_FRAME(_hx_pos_b6868f9adf03d100_53_create,"cpp.vm.Thread","create",0xb01a9834,"cpp.vm.Thread.create","/Applications/blender.app/armsdk/Kha/Tools/haxe/std/cpp/vm/Thread.hx",53,0x53f8ef28)
HX_LOCAL_STACK_FRAME(_hx_pos_b6868f9adf03d100_62_readMessage,"cpp.vm.Thread","readMessage",0x11bc2cd9,"cpp.vm.Thread.readMessage","/Applications/blender.app/armsdk/Kha/Tools/haxe/std/cpp/vm/Thread.hx",62,0x53f8ef28)
namespace cpp{
namespace vm{

void Thread_obj::__construct( ::Dynamic h){
            	HX_STACKFRAME(&_hx_pos_b6868f9adf03d100_31_new)
...
void Thread_obj::sendMessage( ::Dynamic msg){
            	HX_STACKFRAME(&_hx_pos_b6868f9adf03d100_38_sendMessage)
...
int Thread_obj::__compare( ::Dynamic t){
            	HX_STACKFRAME(&_hx_pos_b6868f9adf03d100_66___compare)
...
HX_DEFINE_DYNAMIC_FUNC1(Thread_obj,__compare,return )
 ...
 ::cpp::vm::Thread Thread_obj::current(){
            	HX_GC_STACKFRAME(&_hx_pos_b6868f9adf03d100_46_current)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(Thread_obj,current,return )
 ...
 ::cpp::vm::Thread Thread_obj::create( ::Dynamic callb){
            	HX_GC_STACKFRAME(&_hx_pos_b6868f9adf03d100_53_create)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Thread_obj,create,return )
 ...
 ::Dynamic Thread_obj::readMessage(bool block){
            	HX_STACKFRAME(&_hx_pos_b6868f9adf03d100_62_readMessage)
