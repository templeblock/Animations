...
HX_DEFINE_STACK_FRAME(_hx_pos_fa013d5d6e4c9a5c_32_new,"sys.io.FileOutput","new",0x19e22a16,"sys.io.FileOutput.new","/Applications/blender.app/armsdk/Kha/Tools/haxe/std/cpp/_std/sys/io/FileOutput.hx",32,0x07f7b459)
HX_LOCAL_STACK_FRAME(_hx_pos_fa013d5d6e4c9a5c_36_writeByte,"sys.io.FileOutput","writeByte",0x887099bd,"sys.io.FileOutput.writeByte","/Applications/blender.app/armsdk/Kha/Tools/haxe/std/cpp/_std/sys/io/FileOutput.hx",36,0x07f7b459)
HX_LOCAL_STACK_FRAME(_hx_pos_fa013d5d6e4c9a5c_40_writeBytes,"sys.io.FileOutput","writeBytes",0xda15ec16,"sys.io.FileOutput.writeBytes","/Applications/blender.app/armsdk/Kha/Tools/haxe/std/cpp/_std/sys/io/FileOutput.hx",40,0x07f7b459)
HX_LOCAL_STACK_FRAME(_hx_pos_fa013d5d6e4c9a5c_47_close,"sys.io.FileOutput","close",0xa583caee,"sys.io.FileOutput.close","/Applications/blender.app/armsdk/Kha/Tools/haxe/std/cpp/_std/sys/io/FileOutput.hx",47,0x07f7b459)
namespace sys{
namespace io{

void FileOutput_obj::__construct( ::Dynamic f){
            	HX_STACKFRAME(&_hx_pos_fa013d5d6e4c9a5c_32_new)
...
void FileOutput_obj::writeByte(int c){
            	HX_STACKFRAME(&_hx_pos_fa013d5d6e4c9a5c_36_writeByte)
HXDLIN(  36)		try {
...
int FileOutput_obj::writeBytes( ::haxe::io::Bytes s,int p,int l){
            	HX_STACKFRAME(&_hx_pos_fa013d5d6e4c9a5c_40_writeBytes)
HXDLIN(  40)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
...
void FileOutput_obj::close(){
            	HX_STACKFRAME(&_hx_pos_fa013d5d6e4c9a5c_47_close)
