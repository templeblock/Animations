...
HX_LOCAL_STACK_FRAME(_hx_pos_ad9694584a0ddc3c_33_getBytes,"sys.io.File","getBytes",0xbe457600,"sys.io.File.getBytes","/Applications/blender.app/armsdk/Kha/Tools/haxe/std/cpp/_std/sys/io/File.hx",33,0xea588fda)
HX_LOCAL_STACK_FRAME(_hx_pos_ad9694584a0ddc3c_44_saveBytes,"sys.io.File","saveBytes",0x6700fb83,"sys.io.File.saveBytes","/Applications/blender.app/armsdk/Kha/Tools/haxe/std/cpp/_std/sys/io/File.hx",44,0xea588fda)
HX_LOCAL_STACK_FRAME(_hx_pos_ad9694584a0ddc3c_51_read,"sys.io.File","read",0x203d07e1,"sys.io.File.read","/Applications/blender.app/armsdk/Kha/Tools/haxe/std/cpp/_std/sys/io/File.hx",51,0xea588fda)
HX_LOCAL_STACK_FRAME(_hx_pos_ad9694584a0ddc3c_55_write,"sys.io.File","write",0xfec8a9f4,"sys.io.File.write","/Applications/blender.app/armsdk/Kha/Tools/haxe/std/cpp/_std/sys/io/File.hx",55,0xea588fda)
namespace sys{
namespace io{
...
bool File_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::io::Bytes File_obj::getBytes(::String path){
            	HX_STACKFRAME(&_hx_pos_ad9694584a0ddc3c_33_getBytes)
...
void File_obj::saveBytes(::String path, ::haxe::io::Bytes bytes){
            	HX_STACKFRAME(&_hx_pos_ad9694584a0ddc3c_44_saveBytes)
...
bool binary = __o_binary.Default(true);
            	HX_GC_STACKFRAME(&_hx_pos_ad9694584a0ddc3c_51_read)
...
bool binary = __o_binary.Default(true);
            	HX_GC_STACKFRAME(&_hx_pos_ad9694584a0ddc3c_55_write)
