...
HX_DEFINE_STACK_FRAME(_hx_pos_d6a1a989a24ad0d0_32_new,"sys.io.FileInput","new",0x565591b9,"sys.io.FileInput.new","/Applications/blender.app/armsdk/Kha/Tools/haxe/std/cpp/_std/sys/io/FileInput.hx",32,0x42b78a78)
HX_LOCAL_STACK_FRAME(_hx_pos_d6a1a989a24ad0d0_36_readByte,"sys.io.FileInput","readByte",0x25e0b585,"sys.io.FileInput.readByte","/Applications/blender.app/armsdk/Kha/Tools/haxe/std/cpp/_std/sys/io/FileInput.hx",36,0x42b78a78)
HX_LOCAL_STACK_FRAME(_hx_pos_d6a1a989a24ad0d0_47_readBytes,"sys.io.FileInput","readBytes",0xfebe1f4e,"sys.io.FileInput.readBytes","/Applications/blender.app/armsdk/Kha/Tools/haxe/std/cpp/_std/sys/io/FileInput.hx",47,0x42b78a78)
HX_LOCAL_STACK_FRAME(_hx_pos_d6a1a989a24ad0d0_63_seek,"sys.io.FileInput","seek",0x37d7f1ff,"sys.io.FileInput.seek","/Applications/blender.app/armsdk/Kha/Tools/haxe/std/cpp/_std/sys/io/FileInput.hx",63,0x42b78a78)
namespace sys{
namespace io{

void FileInput_obj::__construct( ::Dynamic f){
            	HX_STACKFRAME(&_hx_pos_d6a1a989a24ad0d0_32_new)
...
int FileInput_obj::readByte(){
            	HX_GC_STACKFRAME(&_hx_pos_d6a1a989a24ad0d0_36_readByte)
HXDLIN(  36)		try {
...
int FileInput_obj::readBytes( ::haxe::io::Bytes s,int p,int l){
            	HX_GC_STACKFRAME(&_hx_pos_d6a1a989a24ad0d0_47_readBytes)
HXDLIN(  47)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
...
void FileInput_obj::seek(int p, ::sys::io::FileSeek pos){
            	HX_STACKFRAME(&_hx_pos_d6a1a989a24ad0d0_63_seek)
